...
class Parameters():
    def __init__(self) -> None:
        ...
        self.stabilizer_amount = 0.62
        self.stabilizer_min_blend = 0.18
        self.stabilizer_max_blend = 0.92
        self.stabilizer_motion_response = 0.16
        self.stabilizer_visibility_bias = 0.22
        self.stabilizer_prediction = 0.18
        self.stabilizer_floor_smoothing = 0.92
        self.stabilizer_floor_visibility = 0.35
        self.foot_lock_speed_threshold = 0.04
        self.foot_lock_height_threshold = 0.08
        self.foot_lock_visibility_threshold = 0.45
        self.foot_lock_frames = 4
        self.foot_lock_amount = 0.9
        self.foot_lock_anchor_blend = 0.82
        self.torso_lean_strength = 0.32
    ...
    def change_recalibrate(self):
        ...
        self.osc_realign_now = True

    def request_osc_realign(self):
        self.osc_realign_now = True
